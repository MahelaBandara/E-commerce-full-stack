...
export default function Product() {
  ...
  const colourValue = searchParamms.get("color");
      ...
      <div>
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-10">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <form className="hidden lg:block">
                <div className='py-10 felx justify-between items-center'>
                  <h1 className='text-lg font-bold opacity-50'>Filters&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<FilterListIcon/>}</h1> 
                </div>
                {filters.map((section) => (
                ...
                {singleFilter.map((section) => (
                                <Disclosure as="div" key={section.id} className="border-b border-gray-200 py-6">
                                    ...
                                    <>
                                        <h3 className="-my-3 flow-root">
                                        <Disclosure.Button className="flex h-[1rem] w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
          ...
          <section className="w-full px=[3.6rem] ">
            <div className="px-1200 py-5 flex justify-center">
